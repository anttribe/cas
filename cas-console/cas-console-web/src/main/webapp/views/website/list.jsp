                ...
                <div class="col-sm-12">
                    <section class="panel">
                        <header class="panel-heading">
                            <spring:message code="app.website.title" />
                            <span class="tools pull-right"></span>
                        </header>
                        <div class="panel-body">
                            <div class="search-body">
                                <div class="btn-group">
                                    <a href="#none" class="btn btn-primary btn-sm action-add"><i class="fa fa-plus"></i> <spring:message code="app.website.action.add" /></a>
                                </div>
        ...
        <script type="text/javascript">
	        $(function(){
	        	$('.action-add').click(function(){
	        		location.href = '${contextPath}/website/add';
	        	});
	        	$('.action-edit', '#website-table').bind('click', function(e){
	            	e.preventDefault();
    			...
    			$('.action-delete', '#website-table').bind('click', function(e){
                	e.preventDefault();
